  ...
  echo "<p>".mostrarfecha()."</p>"; ?></p></div>
            ...
            <div class="boxmainRT" style="width:216px;">
              ...
              <div id="loginbottLT" class="boxbottLT"></div>
				...
				<div id="add">
		 		...
		 		<div class="boxheadLT"></div>
						<div class="boxmain">
							<div class="boxmainRT" style="width: 248px;">
		       ...
		       <h1>formulario de subcripcion</h1><div id="products">
        ...
        <form class="" action="index.html" method="post">
          ...
          <br>
					...
					<p class="label3">Cuenta: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="usuario" type="text" size="26" /></p>

					 <br>
           	<p class="label3">Roles:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select><option value="masculino">Vendedor</option><option value="femenino">Comprador</option></select> </p>
            <br>
